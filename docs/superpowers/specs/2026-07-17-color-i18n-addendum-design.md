...
2. 지판 노트/마크 색상은 **그대로 유지** (사용자 결정 — 악기 영역 웜 톤 유지).
   - 후속 결정(2026-07-17): 루트만 테라코타 → **코럴 로즈**(라이트 `#d64560`/링 `#a52e45`, 다크 `#e0566e`/링 `#f2a0ae`)로 교체. 비교 시안 4종 검토 후 확정 — 이전 브랜드 색 인상 제거 + 다크 코드톤에서 6개 도수색과의 구분 최적. 파비콘 동기 교체. 도수/마크/스케일음 색은 계속 유지.
